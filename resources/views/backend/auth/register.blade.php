...
@section('content')
    ...
    <div class="content">
        ...
        <p>Lupakan pembuatan CRUD dari nol. Main Master hadir sebagai fondasi utama Anda untuk pengembangan aplikasi yang efisien dan inovatif.</p>
        <div class="cta">
            <p>Sudah siap mengakselerasi pengembangan?</p>
                ...
                <form method="post" name="form-register" id="form-register">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="first_name" id="first_name" type="text" class="form-control ps-15 bg-transparent" placeholder="Nama Depan" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
                                    <input name="last_name" id="last_name" type="text" class="form-control ps-15 bg-transparent" placeholder="Nama Belakang" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input name="password" id="password" type="password" class="form-control ps-15 bg-transparent" placeholder="Kata Sandi" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <span class="input-group-text bg-transparent"><i class="fas fa-lock"></i></span>
                            <input name="validate_password" id="validate_password" type="password" class="form-control ps-15 bg-transparent" placeholder="Ulangi Kata Sandi" required>
                        </div>
